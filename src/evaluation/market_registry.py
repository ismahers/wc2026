...
REGISTRY: tuple[MarketRegistryEntry, ...] = (
    ...
    MarketRegistryEntry(
        ...
        stake_allowed=False,
        backtest_status="partial_backtest_needed",
        odds_status="available_current_partial_historical",
        default_tracking_action="paper_track",
        notes="XGBoost has direct Over 2.5 model; not yet promoted to real staking.",
        next_step="Run dedicated Over/Under 2.5 backtest and track CLV.",
    ),
    MarketRegistryEntry(
    ...
    MarketRegistryEntry(
        ...
        odds_status="needs_market_odds",
        default_tracking_action="paper_track",
        notes="Direct XGBoost model exists, but validation metrics are weaker than Over 2.5.",
        next_step="Collect BTTS odds and run dedicated backtest.",
    ),
    MarketRegistryEntry(
